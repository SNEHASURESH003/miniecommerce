...
SECRET_KEY = 'django-insecure-*i%h(1!8m!*$ww)7ahiy-s#kv*tiryyql)00$br0n-i8k4wr#n'
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles','ministore'
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'miniecommerce_db',#Name of the database created for this project
